...
public class HowToGenerateRandamScreenshotAssignment1 {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		File destination=new File("Users\\abhishek\\soniya-eclipse-workspace\\Selenium2\\screenshots\\"+ new HowToGenerateRandamScreenshotAssignment1().getClass()+Math.random()+".png");
